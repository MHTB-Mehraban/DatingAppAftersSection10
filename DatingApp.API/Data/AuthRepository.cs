...
namespace DatingApp.API.Data
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public async Task<User> Login(string usernsme, string password)
        {
            var user = await _context.Users.Include(c => c.Photos).FirstOrDefaultAsync(c => c.Username == usernsme);
            if (user == null)
                return null;
